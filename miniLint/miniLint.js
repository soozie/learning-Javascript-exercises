...
for (let i = 0; i < overusedWords.length; i++) {
  ...
  storyWords.forEach(function(word) {
	...
	console.log('There are ' + countOverusedWords + ' of: ' + overusedWords[i]);
};
...
console.log('There are ' + betterWords.length + ' words after removing the unnecessary words');
console.log('There are ' + countSentences + ' sentences');
}
